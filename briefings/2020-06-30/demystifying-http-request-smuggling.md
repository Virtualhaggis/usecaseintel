# [CRIT] Demystifying HTTP request smuggling

**Source:** Snyk
**Published:** 2020-06-30
**Article:** https://snyk.io/blog/demystifying-http-request-smuggling/
...
`UC_3313_5` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
`UC_3313_6` · phase: **exploit** · confidence: **High** · AI-generated for this article
...
`UC_3313_4` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Demystifying HTTP request smuggling ```
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2020-12440`, `CVE-2019-16786`
