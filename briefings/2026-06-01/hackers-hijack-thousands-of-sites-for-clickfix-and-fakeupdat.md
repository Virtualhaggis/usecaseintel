...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `91.92.240.127`, `46.226.166.57`, `147.45.42.200`, `147.45.42.205`, `beacontrace.bond`, `webgleam.info`, `check.first-node.rocks`, `first-node.rocks` _(+20 more)_
