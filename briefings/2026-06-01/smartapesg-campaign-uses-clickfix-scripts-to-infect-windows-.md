# [MED] SmartApeSG Campaign Uses ClickFix Scripts to Infect Windows Hosts With RAT Malware

**Source:** Cyber Security News
**Published:** 2026-06-01
**Article:** https://cybersecuritynews.com/smartapesg-campaign-uses-clickfix-scripts/

## Threat Profile

A well-known social engineering campaign called SmartApeSG is back in the spotlight, this time using ClickFix scripts to quietly plant remote access malware on Windows computers. The campaign lures victims through fake verification pages that trick them into running a malicious script without realizing the full damage it causes. What makes this wave especially concerning [&#8230;] The post SmartApeSG Campaign Uses ClickFix Scripts to Infect Windows Hosts With RAT Malware appeared first on Cyber …

## Indicators of Compromise (high-fidelity only)

- **IPv4 (defanged):** `178.156.165.82`
- **IPv4 (defanged):** `178.156.173.194`
- **IPv4 (defanged):** `89.110.110.119`
- **IPv4 (defanged):** `185.163.47.217`
- **Domain (defanged):** `hiddenplanetlab.top`
- **Domain (defanged):** `silverharvestnetwork.com`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `178.156.165.82`, `178.156.173.194`, `89.110.110.119`, `185.163.47.217`, `hiddenplanetlab.top`, `silverharvestnetwork.com`

- **File hash IOCs — endpoint file/process match** ([template](../_TEMPLATES.md#hash-ioc)) — phase: **install**, confidence: **High**
  - file hash IOC(s): `1514b1268e9dc6d2f37137aa38c756cb4bf8186ac9235d6863b78e7f8bbbe976`, `469bac8e10f50263e8ff0806e6ba126bb4cc660799129a8653eab3f8ec7201e5`, `9c7eda2c4d3aaa8746495741bef57a07de180f0409409faf0f91658e88ba33f5`, `7ba5481c873bb3081442561f749f590badd72ef249fddfe993e30b28dc0c2112`
