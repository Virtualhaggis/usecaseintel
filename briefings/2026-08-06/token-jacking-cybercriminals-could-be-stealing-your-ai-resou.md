# [HIGH] Token Jacking: Cybercriminals Could Be Stealing Your AI Resources

**Source:** Unit 42 (Palo Alto)
**Published:** 2026-08-06
**Article:** https://unit42.paloaltonetworks.com/ai-token-jacking/
...
8 min read 
Related Products Advanced URL Filtering Cloud-Delivered Security Services Code to Cloud Platform Cortex Cortex Cloud Cortex XDR Cortex XSIAM Prisma AIRS Unit 42 AI Security Assessment Unit 42 Incident Response 
By: Unit 42 
...
- **IPv4 (defanged):** `3.235.109.125`
- **IPv4 (defanged):** `116.105.166.148`
- **IPv4 (defanged):** `172.96.142.186`
- **IPv4 (defanged):** `38.46.219.166`
...
`UC_112_10` · phase: **install** · confidence: **Medium** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `3.235.109.125`, `116.105.166.148`, `172.96.142.186`, `38.46.219.166`
