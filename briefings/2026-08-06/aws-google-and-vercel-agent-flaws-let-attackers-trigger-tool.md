...
| where InitiatingProcessFileName in~ ("npm","npx","node","pnpm","yarn","sh","bash","dash","make","python","python3")
    or InitiatingProcessCommandLine has_any ("postinstall","preinstall","prepare","node_modules/.bin","lifecycle")
...
### Exposure inventory: hosts running CoreBreak-vulnerable AWS/Google/Vercel agent framework versions

`UC_48_7` · phase: **weapon** · confidence: **Low** · AI-generated for this article
...
`UC_48_5` · phase: **exploit** · confidence: **High**
