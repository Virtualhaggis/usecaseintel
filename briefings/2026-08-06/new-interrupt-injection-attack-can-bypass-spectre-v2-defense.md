# [CRIT] New Interrupt Injection Attack Can Bypass Spectre v2 Defenses on Intel and AMD CPUs

**Source:** The Hacker News
**Published:** 2026-08-06
**Article:** https://thehackernews.com/2026/08/new-interrupt-injection-attack-can.html

## Threat Profile

New Interrupt Injection Attack Can Bypass Spectre v2 Defenses on Intel and AMD CPUs 
 Swati Khandelwal  Aug 06, 2026 Vulnerability / Hardware Security 
...
MIT CSAIL researchers Daniël Trujillo and Mengjia Yan named the technique INTERRUPT INJECTION . On an AMD Zen 2 machine running Linux 6.…
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — New Interrupt Injection Attack Can Bypass Spectre v2 Defenses on Intel and AMD C ```
| tstats `summariesonly` count
