# [MED] Understanding Amazon S3 security and compliance on AWS

**Source:** Snyk
**Published:** 2019-05-10
**Article:** https://snyk.io/blog/understanding-amazon-s3-security/
...
If your organization uses Amazon Web Services (AWS) for cloud computing, chances are that Amazon S3, or Amazon Simple Storage Service, gets a lot of use. The object storage service was one of the first cloud services offered by AWS (way back in 2006!), and it’s ease of use, reliability, and scalability h…
