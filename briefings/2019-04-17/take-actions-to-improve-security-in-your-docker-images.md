# [HIGH] Take actions to improve security in your Docker images

**Source:** Snyk
**Published:** 2019-04-17
**Article:** https://snyk.io/blog/take-actions-to-improve-security-in-your-docker-images/
...
Or download our lovely handcrafted pdf report which contains all of this in…
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Take actions to improve security in your Docker images ```
