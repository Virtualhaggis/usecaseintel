# [CRIT] Malicious NuGet Packages Target Browser Credentials, SSH Keys, and Crypto Wallets

**Source:** Cyber Security News
**Published:** 2026-05-07
**Article:** https://cybersecuritynews.com/malicious-nuget-packages-target-browser-credentials/
...
- **IPv4 (defanged):** `62.84.102.85`
- **IPv4 (defanged):** `47.100.60.237`
- **Domain (defanged):** `dns-providersa2.com`
- **Domain (defanged):** `git.justdotrip.com`
- **Domain (defanged):** `1-you.njalla.no`
- **Domain (defanged):** `2-can.njalla.in`
- **Domain (defanged):** `3-get.njalla.fo`
- **SHA256:** `e1869d6571894f058dd4ab2b66f060628dc364ee8e29afbd2323c95e5002fb8e`
- **SHA256:** `8f7aa15c77bde94087bb74dfc072e25212797b313731b4cad0ded3e152268dcf`
- **SHA256:** `34e2d63b5db7e24c808711c2ca0c0a42afde97a0086d7d81609110c002d18d7c`
- **SHA256:** `b8543b2a1ad8862ebfef18924cf5444d2adfee996939963f4fc2748c582cf9a9`
- **SHA256:** `b8fa1b2fade45304c003909e375d2519ea447b498b7d93fe7c50db014d30f4fa`
- **SHA256:** `019e6c2cf58386039133981f3377b085fbd70c98ae8613c7c6a4f10a9f2d9824`
- **SHA256:** `596c453c9dbb7240f1ce05cc025496524ce7c538c23a9b2171174bf32b5691a1`
- **SHA1:** `efb675de4b3af3dac3c9cae91075fd7cc2f4f98e`
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Malicious NuGet Packages Target Browser Credentials, SSH Keys, and Crypto Wallet ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("we4ftg.exe","s4.exe") OR Processes.process_path="*C:\ProgramData\Microsoft*")
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_path="*C:\ProgramData\Microsoft*" OR Filesystem.file_name IN ("we4ftg.exe","s4.exe"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("we4ftg.exe", "s4.exe") or FolderPath has_any ("C:\ProgramData\Microsoft"))
...
| where (FolderPath has_any ("C:\ProgramData\Microsoft") or FileName in~ ("we4ftg.exe", "s4.exe"))
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `62.84.102.85`, `47.100.60.237`, `dns-providersa2.com`, `git.justdotrip.com`, `1-you.njalla.no`, `2-can.njalla.in`, `3-get.njalla.fo`

- **File hash IOCs — endpoint file/process match** ([template](../_TEMPLATES.md#hash-ioc)) — phase: **install**, confidence: **High**
  - file hash IOC(s): `e1869d6571894f058dd4ab2b66f060628dc364ee8e29afbd2323c95e5002fb8e`, `8f7aa15c77bde94087bb74dfc072e25212797b313731b4cad0ded3e152268dcf`, `34e2d63b5db7e24c808711c2ca0c0a42afde97a0086d7d81609110c002d18d7c`, `b8543b2a1ad8862ebfef18924cf5444d2adfee996939963f4fc2748c582cf9a9`, `b8fa1b2fade45304c003909e375d2519ea447b498b7d93fe7c50db014d30f4fa`, `019e6c2cf58386039133981f3377b085fbd70c98ae8613c7c6a4f10a9f2d9824`, `596c453c9dbb7240f1ce05cc025496524ce7c538c23a9b2171174bf32b5691a1`, `efb675de4b3af3dac3c9cae91075fd7cc2f4f98e`
