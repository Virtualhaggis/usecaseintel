# [HIGH] Slopsquatting, Phantom Domains, and HalluSquatting Are the Same AI Attack

**Source:** BleepingComputer
**Published:** 2026-07-24
**Article:** https://www.bleepingcomputer.com/news/security/slopsquatting-phantom-domains-and-hallusquatting-are-the-same-ai-attack/
...
| where FileName in~ ("npm.exe","npm","npx.exe","npx","node.exe","yarn.exe","yarn","pnpm.exe","pnpm","cmd.exe","powershell.exe","pwsh.exe","bash.exe","sh.exe")
