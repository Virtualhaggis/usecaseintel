# [CRIT] Sandworm-Linked UAC-0145 Uses Fake Job Interviews to Push VPN That Can Run Commands

**Source:** The Hacker News
**Published:** 2026-08-11
**Article:** https://thehackernews.com/2026/08/sandworm-linked-uac-0145-uses-fake-job.html

## Threat Profile

Sandworm-Linked UAC-0145 Uses Fake Job Interviews to Push VPN That Can Run Commands 
 Ravie Lakshmanan  Aug 11, 2026 Social Engineering / Malware 
...
CERT-UA pinned the activity on a threat cluster it tracks as UAC-0145 , which …

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `soprasteria-bg.com`
- **Domain (defanged):** `sourceforge.net`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `soprasteria-bg.com`, `sourceforge.net`
