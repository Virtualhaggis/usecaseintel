# [CRIT] AsyncAPI npm packages compromised with Miasma variant

**Source:** Aikido, StepSecurity
**Published:** 2026-07-14
**Article:** https://www.aikido.dev/blog/asyncapi-npm-packages-compromised-with-miasma-variant
...
### Article-specific behavioural hunt — AsyncAPI npm packages compromised with Miasma variant

`UC_3_8` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — AsyncAPI npm packages compromised with Miasma variant ```
