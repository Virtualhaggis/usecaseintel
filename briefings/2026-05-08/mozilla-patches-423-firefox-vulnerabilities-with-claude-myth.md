# [CRIT] Mozilla Patches 423 Firefox Vulnerabilities with Claude Mythos and Other AI Models

**Source:** Cyber Security News
**Published:** 2026-05-08
**Article:** https://cybersecuritynews.com/firefox-423-0-day-vulnerabilities/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Mozilla Patches 423 Firefox Vulnerabilities with Claude Mythos and Other AI Mode ```
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2026-6746`, `CVE-2026-6757`, `CVE-2026-6758`
