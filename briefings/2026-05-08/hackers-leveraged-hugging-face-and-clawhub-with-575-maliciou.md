# [HIGH] Hackers Leveraged Hugging Face and ClawHub With 575+ Malicious Skills to Deploy Malware

**Source:** Cyber Security News
**Published:** 2026-05-08
**Article:** https://cybersecuritynews.com/hackers-leverage-hugging-face-and-clawhub/
...
- **Domain (defanged):** `velvet-parrot.com`
...
`UC_18_12` · phase: **c2** · confidence: **High**
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Hackers Leveraged Hugging Face and ClawHub With 575+ Malicious Skills to Deploy ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("cdc1.bat"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("cdc1.bat"))
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `91.92.242.30`, `velvet-parrot.com`
