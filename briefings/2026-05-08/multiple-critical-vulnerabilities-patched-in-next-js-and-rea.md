# [CRIT] Multiple Critical Vulnerabilities Patched in Next.js and React Server Components

**Source:** Cyber Security News
**Published:** 2026-05-08
**Article:** https://cybersecuritynews.com/next-js-react-server-vulnerabilities/
...
`UC_7_6` · phase: **exploit** · confidence: **Medium**
...
`UC_7_7` · phase: **exploit** · confidence: **Medium**
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Multiple Critical Vulnerabilities Patched in Next.js and React Server Components ```
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2026-23870`, `CVE-2026-44578`, `CVE-2026-44573`
