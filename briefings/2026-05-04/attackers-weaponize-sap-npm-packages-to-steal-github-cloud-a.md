# [HIGH] Attackers Weaponize SAP npm Packages to Steal GitHub, Cloud, and AI Coding Tool Secrets

**Source:** Cyber Security News
**Published:** 2026-05-04
**Article:** https://cybersecuritynews.com/attackers-weaponize-sap-npm-packages/
...
The attack hit four official SAP-published pack…
...
### Article-specific behavioural hunt — Attackers Weaponize SAP npm Packages to Steal GitHub, Cloud, and AI Coding Tool

`UC_17_4` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Attackers Weaponize SAP npm Packages to Steal GitHub, Cloud, and AI Coding Tool ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("execution.js","node.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("execution.js","node.js"))
...
| where (FileName in~ ("execution.js", "node.js"))
