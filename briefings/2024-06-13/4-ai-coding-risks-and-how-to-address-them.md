# [MED] 4 AI coding risks and how to address them

**Source:** Snyk
**Published:** 2024-06-13
**Article:** https://snyk.io/blog/4-ai-coding-risks/
...
June 13, 2024
0 mins read 96% of developers use AI coding tools to generate code, detect bugs, and offer documentation or coding suggestions. Developers rely on tools like ChatGPT and GitHub Copilot so much that roughly 80% of them bypass security protocols to use them.
