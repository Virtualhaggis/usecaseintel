# [CRIT] New 0-Click WhatsApp Account Takeover Attack Targeting iOS 16 Users

**Source:** Cyber Security News
**Published:** 2026-05-27
**Article:** https://cybersecuritynews.com/0-click-whatsapp-target-ios-16-users/
...
**Splunk SPL (CIM):**
```spl
| tstats `summariesonly` count, max(_time) as lastSeen from datamodel=Vulnerabilities.Vulnerabilities where (Vulnerabilities.cve="CVE-2025-43300" OR Vulnerabilities.cve="CVE-2025-55177") by Vulnerabilities.dest, Vulnerabilities.cve, Vulnerabilities.severity, Vulnerabilities.signature, Vulnerabilities.os 
...
| where Timestamp > ago(1d)   // TVM is current-state; 1d gets the latest snapshot
| where CveId in ("CVE-2025-43300", "CVE-2025-55177")
...
| sort by DeviceName asc, CveId asc
```
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2025-43300`, `CVE-2025-55177`
