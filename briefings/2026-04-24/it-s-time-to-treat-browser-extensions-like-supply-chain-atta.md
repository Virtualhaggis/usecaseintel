# [HIGH] It's time to treat browser extensions like supply chain attack vectors

**Source:** Aikido
**Published:** 2026-04-24
**Article:** https://www.aikido.dev/blog/browser-extensions-supply-chain-attack

## Threat Profile

Blog Vulnerabilities & Threats It's time to treat browser extensions like supply chain attack vectors It's time to treat browser extensions like supply chain attack vectors Written by Dania Durnas Published on: Apr 25, 2026 You would never install an application that can log into your Google docs, read your keystrokes in your browser, intercepts requests in transit, runs continuously, updates silently, AND could be powerful enough to steal your passwords, right? Well, this is more or less what b…
...
`UC_348_8` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_348_10` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
...
`UC_348_11` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
