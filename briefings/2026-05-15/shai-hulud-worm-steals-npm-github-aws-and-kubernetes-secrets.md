# [CRIT] Shai-Hulud Worm Steals npm, GitHub, AWS, and Kubernetes Secrets From Developers

**Source:** Cyber Security News
**Published:** 2026-05-15
**Article:** https://cybersecuritynews.com/shai-hulud-worm-steals-npm/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Shai-Hulud Worm Steals npm, GitHub, AWS, and Kubernetes Secrets From Developers ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("ai_init.js","deadman_switch.sh"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("ai_init.js","deadman_switch.sh"))
...
| where (FileName in~ ("ai_init.js", "deadman_switch.sh"))
