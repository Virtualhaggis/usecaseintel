# [CRIT] Microsoft Warns of Attackers Using Trusted HPE Operations Agent for Malware-Free Intrusions

**Source:** Cyber Security News
**Published:** 2026-05-15
**Article:** https://cybersecuritynews.com/microsoft-warns-of-attackers-using-trusted-hpe-operations-agent/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Microsoft Warns of Attackers Using Trusted HPE Operations Agent for Malware-Free ```
