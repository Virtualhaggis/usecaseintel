# [HIGH] [GHSA / CRITICAL] GHSA-v6wj-c83f-v46x: @profullstack/mcp-server vulnerable to OS Command Injection in domain_lookup Module
...
`UC_72_5` · phase: **delivery** · confidence: **Medium**
