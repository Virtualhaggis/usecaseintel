# [HIGH] OSPO security evolution: The Kübler-Ross Model of open source

**Source:** Snyk
**Published:** 2023-01-12
**Article:** https://snyk.io/blog/ospo-security-evolution-kubler-ross-model/

## Threat Profile

Snyk Blog Written by Dan Appelquist 
January 12, 2023
0 mins read What’s in an OSPO? Open Source Program Offices are popping up all over, in recognition of the facts on the ground: open source software (and I would argue open standards as well) plays an enormous role in building and maintaining the software that increasingly drives the planet. The Linux Foundations’ The Evolution of the Open Source Program Office (OSPO) report talks about five stages of development of an OSPO:
Stage 0: Adopting …
