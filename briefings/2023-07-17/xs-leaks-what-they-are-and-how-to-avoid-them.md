# [HIGH] XS leaks: What they are and how to avoid them

**Source:** Snyk
**Published:** 2023-07-17
**Article:** https://snyk.io/blog/xs-leaks/

## Threat Profile

Snyk Blog In this article
Written by Gino Diño 
July 17, 2023
...
Ultimately, XS leaks lead to the disclosure of sensitive information, which malicious actors can use for numero…
...
`UC_1648_4` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — XS leaks: What they are and how to avoid them ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("node.js","express.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("node.js","express.js"))
...
| where (FileName in~ ("node.js", "express.js"))
