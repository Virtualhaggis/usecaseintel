# [MED] The 89% Problem: How LLMs Are Resurrecting the "Dormant Majority" of Open Source

**Source:** Snyk
**Published:** 2026-03-04
**Article:** https://snyk.io/blog/llms-resurrecting-open-source-dormant-majority/

## Threat Profile

Snyk Blog In this article
Written by Noa Yaffe-Ermoza 
Liran Tal 
Ezra Tanzer 
March 4, 2026
0 mins read AI coding assistants are quietly resurrecting millions of abandoned open source packages. For the last decade, developers relied on a simple heuristic for open source security: Prevalence \= Trust. If a package was downloaded millions of times a week ( lodash , react , requests ), we assumed it was "safe enough" because thousands of eyes were on it. If it was obscure, we approached with cauti…
...
`UC_412_1` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — The 89% Problem: How LLMs Are Resurrecting the "Dormant Majority" of Open Source ```
