# [CRIT] Exploring WebExtension security vulnerabilities in React Developer Tools and Vue.js devtools

**Source:** Snyk
**Published:** 2023-11-27
**Article:** https://snyk.io/blog/webextension-security-vulnerabilities-react-developer-tools-vue-js/
...
`UC_1450_4` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
`UC_1450_3` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Exploring WebExtension security vulnerabilities in React Developer Tools and Vue ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("vue.js","development.js","dom.development.js","min.js","global.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("vue.js","development.js","dom.development.js","min.js","global.js"))
...
| where (FileName in~ ("vue.js", "development.js", "dom.development.js", "min.js", "global.js"))
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2023-5654`, `CVE-2023-5718`
