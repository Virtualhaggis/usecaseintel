...
 Ravie Lakshmanan  Jul 22, 2026 Vulnerability / Browser Security 
...
- **CVE:** `CVE-2026-48294`
- **Domain (defanged):** `www.attackers-page.com`
...
`UC_92_13` · phase: **actions** · confidence: **Low** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `www.attackers-page.com`, `www.google.attacker.com`
