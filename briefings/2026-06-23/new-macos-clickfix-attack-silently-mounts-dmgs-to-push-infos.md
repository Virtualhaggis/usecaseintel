# [CRIT] New macOS ClickFix attack silently mounts DMGs to push infostealer

**Source:** BleepingComputer
**Published:** 2026-06-23
**Article:** https://www.bleepingcomputer.com/news/security/new-macos-clickfix-attack-silently-mounts-dmgs-to-push-infostealer/
...
- **IPv4 (defanged):** `196.251.107.171`
- **Domain (defanged):** `svs-verificationdate.beer`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `196.251.107.171`, `svs-verificationdate.beer`
