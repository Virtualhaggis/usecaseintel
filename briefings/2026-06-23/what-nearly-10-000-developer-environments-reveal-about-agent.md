# [MED] What nearly 10,000 developer environments reveal about agentic development risk

**Source:** Snyk
**Published:** 2026-06-23
**Article:** https://snyk.io/blog/agentic-development-security-ai-coding-risk/

## Threat Profile

Snyk Blog In this article
Written by Ricardo Miguel Silva 
June 23, 2026
0 mins read Key findings AI coding tool sprawl is common: 43% of developers run two or more AI coding environments.
...
`UC_301_1` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — What nearly 10,000 developer environments reveal about agentic development risk ```
