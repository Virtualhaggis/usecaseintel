# [CRIT] GlassWorm Hides a RAT Inside a Malicious Chrome Extension

**Source:** Aikido
**Published:** 2026-03-18
**Article:** https://www.aikido.dev/blog/glassworm-chrome-extension-rat

## Threat Profile

Blog Vulnerabilities & Threats GlassWorm Hides a RAT Inside a Malicious Chrome Extension GlassWorm Hides a RAT Inside a Malicious Chrome Extension Written by Ilyas Makari Published on: Mar 18, 2026 A couple of days ago, we covered GlassWorm compromising hundreds of GitHub repositories and a popular React phone number package on npm . We kept digging into the full payload and found a multi-stage framework that installs a persistent RAT and, deep in Stage 3, force-installs a Chrome extension posin…
...
`UC_543_14` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_543_15` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_543_16` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_543_17` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_543_18` · phase: **actions** · confidence: **High** · AI-generated for this article
...
`UC_543_13` · phase: **exploit** · confidence: **High**
...
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("index.js","skuyzycdd.exe","assaac.exe","aghzgy.ps1","node.js") OR Processes.process_path="*%APPDATA%\QtCvyfVWKH\index.js*" OR Processes.process_path="*%LOCALAPPDATA%\QtCvyfVWKH\AghzgY.ps1*" OR Processes.process_path="*%APPDATA%\_node_x64\webrtc\wrtc-win32-x64\index.js*" OR Processes.process_path="*%APPDATA%\_node_x86\node\node.exe*" OR Processes.process_path="*%APPDATA%\_node_x64\node\node.exe*")
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_path="*%APPDATA%\QtCvyfVWKH\index.js*" OR Filesystem.file_path="*%LOCALAPPDATA%\QtCvyfVWKH\AghzgY.ps1*" OR Filesystem.file_path="*%APPDATA%\_node_x64\webrtc\wrtc-win32-x64\index.js*" OR Filesystem.file_path="*%APPDATA%\_node_x86\node\node.exe*" OR Filesystem.file_path="*%APPDATA%\_node_x64\node\node.exe*" OR Filesystem.file_path="*%LOCALAPPDATA%\Google\Chrome\jucku\*" OR Filesystem.file_path="*/Library/Application*" OR Filesystem.file_name IN ("index.js","skuyzycdd.exe","assaac.exe","aghzgy.ps1","node.js"))
