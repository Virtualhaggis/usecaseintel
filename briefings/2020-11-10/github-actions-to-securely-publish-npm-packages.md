# [HIGH] GitHub Actions to securely publish npm packages

**Source:** Snyk
**Published:** 2020-11-10
**Article:** https://snyk.io/blog/github-actions-to-securely-publish-npm-packages/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — GitHub Actions to securely publish npm packages ```
