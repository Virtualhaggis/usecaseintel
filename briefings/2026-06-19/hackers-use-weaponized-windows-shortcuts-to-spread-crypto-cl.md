# [LOW] Hackers Use Weaponized Windows Shortcuts to Spread Crypto Clipper Across USB Drives

**Source:** Cyber Security News
**Published:** 2026-06-19
**Article:** https://cybersecuritynews.com/hackers-use-weaponized-windows-shortcuts/

## Threat Profile

A newly discovered cryptocurrency clipper malware has been quietly stealing digital assets from victims since February 2026, spreading through a trick that most users would never suspect: weaponized Windows shortcut files on USB drives. The malware is not just a simple thief. It comes with worm-like behavior, Tor-based communication, and the ability to execute remote [&#8230;] The post Hackers Use Weaponized Windows Shortcuts to Spread Crypto Clipper Across USB Drives appeared first on Cyber Sec…

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `cgky6bn6ux5wvlybtmm3z255igt52ljml2ngnc5qp3cnw5jlglamisad.onion`
- **Domain (defanged):** `gfoqsewps57xcyxoedle2gd53o6jne6y5nq5eh25muksqwzutzq7b3ad.onion`
- **Domain (defanged):** `he5vnov645txpcv57el2theky2elesn24ebvgwfoewlpftksxp4fnxad.onion`
- **Domain (defanged):** `lyhizqy2js2eh6ufngkbzntouiikdek5zsdj3qwa22b4z6knpqorgiad.onion`
- **Domain (defanged):** `j3bv7g27oramhbxxuv6gl3dcyfmf44qnvju3offdyrap7hurfprq74qd.onion`
- **Domain (defanged):** `shinypogk4jjniry5qi7247tznop6mxdrdte2k6pdu5cyo43vdzmrwid.onion`
- **Domain (defanged):** `7goms4byw26kkbaanz5a5u5234gusot7rp5imzc3ozh66wwcvmcudjid.onion`
- **Domain (defanged):** `facebookwkhpilnemxj7asaniu7vnjjbiltxjqhye3mhbshg7kx5tfyd.onion`
- **Domain (defanged):** `wt26llpl5k6gok3vnaxmucwgzv2wk3l7nuibbh25clghrtus3p5ctsid.onion`
- **Domain (defanged):** `ijzn3sicrcy7guixkzjkib4ukbiilwc3xhnmby4mcbccnsd7j2rekvqd.onion`
