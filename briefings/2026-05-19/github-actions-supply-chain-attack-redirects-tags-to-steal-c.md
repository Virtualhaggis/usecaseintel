# [CRIT] GitHub Actions Supply Chain Attack Redirects Tags to Steal CI/CD Credentials
...
 Ravie Lakshmanan  May 19, 2026 Supply Chain Attack / Malware 
...
"The attack affects packages tied to the npm maintainer account atool, including echarts-for-react, a widely used React wrapper fo…
...
### Article-specific behavioural hunt — GitHub Actions Supply Chain Attack Redirects Tags to Steal CI/CD Credentials

`UC_0_8` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — GitHub Actions Supply Chain Attack Redirects Tags to Steal CI/CD Credentials ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("timeago.js","canvas-nest.js","index.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("timeago.js","canvas-nest.js","index.js"))
...
| where (FileName in~ ("timeago.js", "canvas-nest.js", "index.js"))
