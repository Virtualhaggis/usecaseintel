# [HIGH] Hackers Can Weaponize Lenovo Driver to Terminate EDR Processes

**Source:** Cyber Security News
**Published:** 2026-05-22
**Article:** https://cybersecuritynews.com/lenovo-driver-terminate-edr-processes/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Hackers Can Weaponize Lenovo Driver to Terminate EDR Processes ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("bootrepair.sys"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("bootrepair.sys"))
...
| where (FileName in~ ("bootrepair.sys"))
...
- **File hash IOCs — endpoint file/process match** ([template](../_TEMPLATES.md#hash-ioc)) — phase: **install**, confidence: **High**
  - file hash IOC(s): `5ab36c116767eaae53a466fbc2dae7cfd608ed77721f65e83312037fbd57c946`
