...
`UC_615_10` · phase: **install** · confidence: **High**
...
`UC_615_11` · phase: **install** · confidence: **High**
...
`UC_615_12` · phase: **c2** · confidence: **High**
...
`UC_615_9` · phase: **exploit** · confidence: **High**
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `metrics-flow.com`
