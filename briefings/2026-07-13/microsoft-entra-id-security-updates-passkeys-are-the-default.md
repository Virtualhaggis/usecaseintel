# [HIGH] Microsoft Entra ID security updates: Passkeys are the default authentication method in Entra ID

**Source:** Microsoft Security Blog
**Published:** 2026-07-13
**Article:** https://www.microsoft.com/en-us/security/blog/2026/07/13/microsoft-entra-id-security-updates-passkeys-are-the-default-authentication-method-in-entra-id/

## Threat Profile

Content types News 
Products and services Microsoft Entra 
Microsoft Entra ID 
Topics Identity and access management 
As identity attacks grow more sophisticated in the AI era, organizations need stronger authentication methods that protect users from phishing, credential theft, and social engineering. To address these evolving threats, Microsoft Entra ID is updating its authentication experience by making passkeys the default phishing-resistant authentication method, helping customers reduce re…
