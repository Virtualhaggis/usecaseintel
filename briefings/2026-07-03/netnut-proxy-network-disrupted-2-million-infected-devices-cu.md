...
According to the Google Threat Inte…

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `netnut.com`
- **Domain (defanged):** `netnut.io`
- **Domain (defanged):** `proxyjet.io`
- **Domain (defanged):** `divinetworks.com`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `netnut.com`, `netnut.io`, `proxyjet.io`, `divinetworks.com`
