# [CRIT] Pickle in the Middle – Hijacking Vertex AI Model Uploads for Cross-Tenant RCE

**Source:** Unit 42 (Palo Alto)
**Published:** 2026-06-16
**Article:** https://unit42.paloaltonetworks.com/hijacking-vertex-ai-model/
...
11 min read 
Related Products Cortex Cortex Cloud Unit 42 AI Security Assessment Unit 42 Incident Response 
By: Ori Hadad 
Published: June 16, 2026 
Categories: Cloud Cybersecurity Research 
Threat Research 
Tags: Bucket squatting 
Google Cloud 
Joblib 
Python 
RCE 
...
`UC_180_8` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
...
`UC_180_9` · phase: **actions** · confidence: **Medium** · AI-generated for this article
...
`UC_180_10` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Pickle in the Middle – Hijacking Vertex AI Model Uploads for Cross-Tenant RCE ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("gcs_utils.py"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("gcs_utils.py"))
...
| where (FileName in~ ("gcs_utils.py"))
