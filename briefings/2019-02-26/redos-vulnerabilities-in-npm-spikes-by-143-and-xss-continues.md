# [HIGH] ReDoS vulnerabilities in npm spikes by 143% and XSS continues to grow

**Source:** Snyk
**Published:** 2019-02-26
**Article:** https://snyk.io/blog/redos-vulnerabilities-in-npm-spikes-by-143-and-xss-continues-to-grow/
...
`UC_3546_2` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — ReDoS vulnerabilities in npm spikes by 143% and XSS continues to grow ```
