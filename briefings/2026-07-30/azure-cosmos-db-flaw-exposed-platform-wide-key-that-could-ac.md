# [CRIT] Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database

**Source:** The Hacker News
**Published:** 2026-07-30
**Article:** https://thehackernews.com/2026/07/azure-cosmos-db-flaw-exposed-platform.html

## Threat Profile

Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database 
 Swati Khandelwal  Jul 30, 2026 Vulnerability / Cloud Security 
...
Wiz , which codenamed the chain CosmosEscape , said the exploit chain began with a crafted query against a Gremlin database controlled by the at…
