# [HIGH] Mitigating path traversal vulns in Java with Snyk Code

**Source:** Snyk
**Published:** 2023-03-06
**Article:** https://snyk.io/blog/mitigating-path-traversal-java-snyk-code/
...
`UC_1727_0` · phase: **install** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Mitigating path traversal vulns in Java with Snyk Code ```
