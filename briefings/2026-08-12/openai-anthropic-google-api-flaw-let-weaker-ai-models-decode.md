# [HIGH] OpenAI, Anthropic, Google API Flaw Let Weaker AI Models Decode Stronger Models' Reasoning

**Source:** The Hacker News
**Published:** 2026-08-12
**Article:** https://thehackernews.com/2026/08/openai-anthropic-google-api-flaw-let.html

## Threat Profile

OpenAI, Anthropic, Google API Flaw Let Weaker AI Models Decode Stronger Models' Reasoning 
 Swati Khandelwal  Aug 12, 2026 Vulnerability / Artificial Intelligence 
...
The weakness affected encrypted reasoning objects used by the providers' reasoning APIs, where a block created in on…
