# [MED] Security implications of HTTP response headers

**Source:** Snyk
**Published:** 2023-05-03
**Article:** https://snyk.io/blog/security-implications-of-http-response-headers/
...
May 3, 2023
0 mins read When a web server receives an HTTP request, it is processed and sent back with a response containing the requested resource and any additional information in the form of HTTP response headers. These headers provide important data, such as last-modified dates, content types, and cache-control settings. The browser then uses this information to determine how to display or store that particular resource. This process helps ensu…
...
`UC_1766_1` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Security implications of HTTP response headers ```
