...
**Article:** https://www.stepsecurity.io/blog/binding-gyp-npm-supply-chain-attack-spreads-like-worm

## Threat Profile

Back to Blog Threat Intel binding.gyp: An npm Supply Chain Attack That Spreads Like a Worm self-replicating worm is spreading across the npm registry using binding.gyp, a file that triggers code execution during npm install without touching package.json scripts. The attack bypasses conventional security tools and has already compromised dozens of packages across multiple maintainer accounts. Sai Likhith View LinkedIn June 3, 2026
Share on X Share on X Share on LinkedIn Share on Facebook Follow o…
