# [CRIT] Cavern C2 Uses DNS and Google Apps Script to Blend Into Legitimate Traffic

**Source:** The Hacker News
**Published:** 2026-08-17
**Article:** https://thehackernews.com/2026/08/cavern-c2-uses-dns-and-google-apps.html

## Threat Profile

Cavern C2 Uses DNS and Google Apps Script to Blend Into Legitimate Traffic 
 Ravie Lakshmanan  Aug 17, 2026 Cyber Espionage / Artificial Intelligence 
...
Russian cybersecurity company Kaspersky said its ongoing monitoring of the threat activity cluster since December 2025 has led to the discovery o…
...
### Article-specific behavioural hunt — Cavern C2 Uses DNS and Google Apps Script to Blend Into Legitimate Traffic

`UC_10_9` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Cavern C2 Uses DNS and Google Apps Script to Blend Into Legitimate Traffic ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("googleservice.dll","rnp.dll"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("googleservice.dll","rnp.dll"))
...
| where (FileName in~ ("googleservice.dll", "rnp.dll"))
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `studiotikva.com`
