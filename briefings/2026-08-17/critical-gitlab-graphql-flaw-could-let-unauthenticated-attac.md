# [CRIT] Critical GitLab GraphQL Flaw Could Let Unauthenticated Attackers Delete Public Projects

**Source:** The Hacker News
**Published:** 2026-08-17
**Article:** https://thehackernews.com/2026/08/critical-gitlab-graphql-flaw-could-let.html

## Threat Profile

Critical GitLab GraphQL Flaw Could Let Unauthenticated Attackers Delete Public Projects 
 Swati Khandelwal  Aug 17, 2026 Vulnerability / DevOps 
...
The flaw, tracked as CVE-2026-19478 , has been rated Critical by GitLab an…
...
### GitLab GraphQL mutation delivered over HTTP GET to /api/graphql (CVE-2026-19650)

`UC_5_4` · phase: **exploit** · confidence: **Medium** · AI-generated for this article

**Splunk SPL (CIM):**
```spl
| tstats summariesonly=true allow_old_summaries=true count min(_time) as firstTime max(_time) as lastTime from datamodel=Web where Web.http_method=GET Web.url="*/api/graphql*" (Web.url="*mutation*" OR Web.url="*_json*") by Web.src Web.dest Web.http_user_agent Web.url Web.status | `drop_dm_object_name(Web)` | where status<400 | convert ctime(firstTime) ctime(lastTime) | sort - lastTime
```

### Self-managed GitLab running versions vulnerable to CVE-2026-19478 / CVE-2026-19650

`UC_5_5` · phase: **recon** · confidence: **High** · AI-generated for this article

**Defender KQL:**
```kql
DeviceTvmSoftwareVulnerabilities
| where CveId in ("CVE-2026-19478", "CVE-2026-19650")
...
- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2026-19478`, `CVE-2026-19650`
