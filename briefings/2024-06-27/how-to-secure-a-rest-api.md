# [HIGH] How to secure a REST API?

**Source:** Snyk
**Published:** 2024-06-27
**Article:** https://snyk.io/blog/how-to-secure-rest-api/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — How to secure a REST API? ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("node.js","validator.js","uaparser.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("node.js","validator.js","uaparser.js"))
...
| where (FileName in~ ("node.js", "validator.js", "uaparser.js"))
