# [HIGH] "A Mini Shai-Hulud Has Appeared": Bun-Based Stealer Hits SAP @cap-js and mbt npm Packages
...
### Mini Shai-Hulud npm preinstall chain: node setup.mjs → bun execution.js
...
`UC_485_8` · phase: **install** · confidence: **Medium** · AI-generated for this article
...
### Mini Shai-Hulud post-compromise persistence artifacts in .claude/, .vscode/, .github/workflows/

`UC_485_9` · phase: **actions** · confidence: **High** · AI-generated for this article
