# [HIGH] Steam forum ClickFix attacks infect gamers with XMRig cryptominers

**Source:** BleepingComputer
**Published:** 2026-07-25
**Article:** https://www.bleepingcomputer.com/news/security/steam-forum-clickfix-attacks-infect-gamers-with-xmrig-cryptominers/
...
`UC_15_10` · phase: **actions** · confidence: **High** · AI-generated for this article
...
`UC_15_5` · phase: **exploit** · confidence: **High**
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("system.exe") or FolderPath has_any ("C:\Windows\Background", "C:\Windows\Background\config.json.", "C:\Windows\Background\system.exe"))
...
| where (FolderPath has_any ("C:\Windows\Background", "C:\Windows\Background\config.json.", "C:\Windows\Background\system.exe") or FileName in~ ("system.exe"))
