# [HIGH] Fake Claude app promoted by Bing ads pushes SectopRAT malware

**Source:** BleepingComputer
**Published:** 2026-07-23
**Article:** https://www.bleepingcomputer.com/news/security/fake-claude-app-promoted-by-bing-ads-pushes-sectoprat-malware/
...
`UC_47_8` · phase: **install** · confidence: **Medium** · AI-generated for this article
...
`UC_47_9` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
`UC_47_11` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_47_12` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Fake Claude app promoted by Bing ads pushes SectopRAT malware ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("claudedesktop.exe","libcef.dll","dockerdesktop.exe"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("claudedesktop.exe","libcef.dll","dockerdesktop.exe"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("claudedesktop.exe", "libcef.dll", "dockerdesktop.exe"))
