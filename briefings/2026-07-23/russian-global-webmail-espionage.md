...
3 min read 
Related Products Advanced DNS Security Advanced URL Filtering Cloud-Delivered Security Services Cortex Unit 42 Incident Response 
By: Unit 42 
...
Zimbra webmail 
Executive Summary 
Unit 42 has observed a persistent cyberespionage campa…

## Indicators of Compromise (high-fidelity only)

- **CVE:** `CVE-2025-66376`
- **IPv4 (defanged):** `37.120.247.228`
- **IPv4 (defanged):** `64.226.124.190`
- **IPv4 (defanged):** `104.248.134.194`
- **IPv4 (defanged):** `185.86.79.95`
- **IPv4 (defanged):** `193.238.152.66`
- **IPv4 (defanged):** `194.156.103.193`
- **IPv4 (defanged):** `216.252.238.18`
- **IPv4 (defanged):** `216.252.238.64`
- **IPv4 (defanged):** `216.252.238.104`
- **Domain (defanged):** `analyticemailmeter.com`
- **Domain (defanged):** `emailanalytics.com.ua`
- **Domain (defanged):** `istc-cloud.com`
- **Domain (defanged):** `mailnalysis.com`
- **Domain (defanged):** `synacorzimbra.nl`
- **Domain (defanged):** `zimbra-metadata.com`
- **Domain (defanged):** `zimbrastat.com`
- **Domain (defanged):** `zimbrasoft.com.ua`
- **Domain (defanged):** `zmailanalytics.com`
...
`UC_178_11` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_178_12` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
...
`UC_178_13` · phase: **actions** · confidence: **Medium** · AI-generated for this article
...
`UC_178_14` · phase: **exploit** · confidence: **High** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `37.120.247.228`, `64.226.124.190`, `104.248.134.194`, `185.86.79.95`, `193.238.152.66`, `194.156.103.193`, `216.252.238.18`, `216.252.238.64` _(+10 more)_

- **Asset exposure — vulnerability matches article CVE(s)** ([template](../_TEMPLATES.md#asset-exposure)) — phase: **recon**, confidence: **High**
  - CVE(s): `CVE-2025-66376`
