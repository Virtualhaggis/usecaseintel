# [CRIT] Attackers Weaponize GitHub Actions Runners to Target cPanel and WHM Servers

**Source:** The Hacker News
**Published:** 2026-07-23
**Article:** https://thehackernews.com/2026/07/attackers-weaponize-github-actions.html

## Threat Profile

Attackers Weaponize GitHub Actions Runners to Target cPanel and WHM Servers 
 Ravie Lakshmanan  Jul 23, 2026 Vulnerability / Web Security 
...
The activity involves malicious Packagist development versions spanning 10 packages associated with a legitimate PHP and DevOps developer, di…

## Indicators of Compromise (high-fidelity only)

- **CVE:** `CVE-2026-41940`
- **IPv4 (defanged):** `43.228.157.68`
- **Domain (defanged):** `f5b0b742-240a-4811-8a5b-b0ba606085d.dnshook.site`
...
`UC_100_14` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `43.228.157.68`, `f5b0b742-240a-4811-8a5b-b0ba606085d.dnshook.site`
