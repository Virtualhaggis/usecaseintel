# [CRIT] Cruciferra Crypter Uses BYOVD and Process Ghosting to Hide Windows Malware

**Source:** The Hacker News
**Published:** 2026-07-27
**Article:** https://thehackernews.com/2026/07/cruciferra-crypter-uses-byovd-and.html

## Threat Profile

Cruciferra Crypter Uses BYOVD and Process Ghosting to Hide Windows Malware 
 Ravie Lakshmanan  Jul 27, 2026 Malware / Email Security 
...
According to a new analysis by Proofpoint, Cruciferra has been utilized by various unrelated cybercriminal threat clusters to d…

## Indicators of Compromise (high-fidelity only)

- **IPv4 (defanged):** `89.34.90.99`
...
- **Domain (defanged):** `gatuso.duckdns.org`
- **Domain (defanged):** `0zbqnac1t4dv2t2wuodv1m.com`
- **Domain (defanged):** `almacensantangel.com`
- **Domain (defanged):** `hsahyteiows.gu.cc`
- **Domain (defanged):** `yicoweytcbtw.gu.cc`
- **Domain (defanged):** `nciyeyrawoe.gu.cc`
- **Domain (defanged):** `lasiduutfe.gu.cc`
- **Domain (defanged):** `xkcifgieusr.gu.cc`
- **Domain (defanged):** `viuyeyrwqs.gu.cc`
- **Domain (defanged):** `pmcjsuyraw.gu.cc`
- **Domain (defanged):** `laiwutrencr.gu.cc`
- **Domain (defanged):** `maisytawe.gu.cc`
- **Domain (defanged):** `kawosyetw.gu.cc`
- **Domain (defanged):** `nviuawusye.gu.cc`
- **Domain (defanged):** `faeytrdeaw.gu.cc`
- **Domain (defanged):** `figyuyrqwr.gu.cc`
- **Domain (defanged):** `hfyuayustrv.gu.cc`
- **Domain (defanged):** `jsiruytrawey.gu.cc`
- **Domain (defanged):** `kawuuterta.gu.cc`
- **Domain (defanged):** `nvsieyrrawe.gu.cc`
- **Domain (defanged):** `fuaytrwese.love`
- **Domain (defanged):** `qeuasytua.love`
- **Domain (defanged):** `svuatwea.love`
- **Domain (defanged):** `vusuydryt.love`
- **SHA256:** `3c181f642e24c28602a87be7f195e2f3d1ffa30b37e20f5121d99f88b22ab80e`
- **SHA256:** `66dbe675480dc229e5b3ab8ad74207f73486e64e57805074f784bb2e01bcb865`
- **SHA256:** `a6fb779be35592fb0ff624a8f8e12ab3cafe7bcfc312cd98263814db7fb01e02`
- **SHA256:** `59ad96dd3b4d5f10a5c53bbd465446e52dc7701a4ac633632f762bf1336d3347`
- **SHA256:** `6dbd6f9f2fa636c16ac4fa81418b68a604424861b9650dd9c4f2b0ba6f67d6ac`
- **SHA256:** `3f31aee0948d16f8d64bf6bec69a4331099993e502b11bfc56b2c0112024489d`
- **SHA256:** `17aae57cf6255c7eb169bf62ea67376d9708976eb7831f8cdd0ea38bdcb37dc4`
- **SHA256:** `2fdfdd13a0c548bb68c9d5aa8599a9265d4659da3e237fe7a42ac6ac06b9a06a`
- **SHA256:** `c4e93449453cf67c5d5605bb8f425207a738a242fdb432d720acc32faa74926c`
- **SHA256:** `c5b1e9aafc8f2b4ab05effc00fd43f3114b9ef1d592a086c952793ac4e299809`
- **SHA256:** `7887e919555fb5948c217556ba149392a72982b1bc427d3db779db9dcbf09ee8`
...
- **SHA256:** `c46e907886e2158cbc453e767183aecf07887b5ac8848f19684451883d69f5f0`
...
- **SHA256:** `6c9ae8a979ad18da2927ae4fdbd73d3c870ead4ea3d437656a3bdcc81b85a050`
...
`UC_97_10` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_97_11` · phase: **install** · confidence: **Medium** · AI-generated for this article
...
`UC_97_12` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
`UC_97_13` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_97_14` · phase: **install** · confidence: **Medium** · AI-generated for this article
...
`UC_97_8` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Cruciferra Crypter Uses BYOVD and Process Ghosting to Hide Windows Malware ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("goflydrv.sys"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("goflydrv.sys"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("goflydrv.sys"))
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `89.34.90.99`, `204.194.48.250`, `118.107.0.197`, `27.50.54.191`, `223.26.63.40`, `117.44.201.119`, `govtop.one`, `ikkkkddd.com` _(+28 more)_

- **File hash IOCs — endpoint file/process match** ([template](../_TEMPLATES.md#hash-ioc)) — phase: **install**, confidence: **High**
  - file hash IOC(s): `3c181f642e24c28602a87be7f195e2f3d1ffa30b37e20f5121d99f88b22ab80e`, `66dbe675480dc229e5b3ab8ad74207f73486e64e57805074f784bb2e01bcb865`, `a6fb779be35592fb0ff624a8f8e12ab3cafe7bcfc312cd98263814db7fb01e02`, `59ad96dd3b4d5f10a5c53bbd465446e52dc7701a4ac633632f762bf1336d3347`, `6dbd6f9f2fa636c16ac4fa81418b68a604424861b9650dd9c4f2b0ba6f67d6ac`, `3f31aee0948d16f8d64bf6bec69a4331099993e502b11bfc56b2c0112024489d`, `17aae57cf6255c7eb169bf62ea67376d9708976eb7831f8cdd0ea38bdcb37dc4`, `2fdfdd13a0c548bb68c9d5aa8599a9265d4659da3e237fe7a42ac6ac06b9a06a` _(+22 more)_
