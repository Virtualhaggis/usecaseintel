# [CRIT] PyTorch Lightning Compromised in PyPI Supply Chain Attack to Steal Credentials
...
### Article-specific behavioural hunt — PyTorch Lightning Compromised in PyPI Supply Chain Attack to Steal Credentials

`UC_4_10` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — PyTorch Lightning Compromised in PyPI Supply Chain Attack to Steal Credentials ```
...
`UC_4_12` · phase: **actions** · confidence: **High**
