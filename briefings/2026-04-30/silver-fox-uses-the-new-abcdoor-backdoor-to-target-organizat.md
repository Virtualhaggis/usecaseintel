...
- **Domain (defanged):** `file.exe`
- **Domain (defanged):** `gst.pdf`
- **Domain (defanged):** `cbdt.rar`
- **Domain (defanged):** `steganography.rs`
- **Domain (defanged):** `ipv4.rs`
- **Domain (defanged):** `ipv6.rs`
- **Domain (defanged):** `mac.rs`
- **Domain (defanged):** `rc4.rs`
- **Domain (defanged):** `uuid.rs`
- **Domain (defanged):** `key.most`
- **Domain (defanged):** `builder.the`
- **Domain (defanged):** `guard.rs`
...
- **Domain (defanged):** `online-module.dll`
- **Domain (defanged):** `geoplugin.net`
- **Domain (defanged):** `yd20251001143052.zip`
- **Domain (defanged):** `yn20250923193706.zip`
- **Domain (defanged):** `powershell.exe`
- **Domain (defanged):** `system.net.servicepointmanager`
- **Domain (defanged):** `system.net.securityprotocoltype`
- **Domain (defanged):** `111.zip`
- **Domain (defanged):** `curl.exe`
- **Domain (defanged):** `ffmpeg.exe`
- **Domain (defanged):** `update.bat`
- **Domain (defanged):** `cmd.exe`
- **Domain (defanged):** `pythonw.exe`
- **Domain (defanged):** `main.py`
- **Domain (defanged):** `appclient.core`
- **Domain (defanged):** `socket.io`
- **Domain (defanged):** `device.log`
- **Domain (defanged):** `os.startfile`
- **Domain (defanged):** `update.zip`
- **Domain (defanged):** `suvidha.exe`
- **Domain (defanged):** `download.php`
- **Domain (defanged):** `abc.fetish`
- **Domain (defanged):** `appclient.zip`
- **Domain (defanged):** `gstsuvidha.exe`
- **Domain (defanged):** `mca-ministry.exe`
- **Domain (defanged):** `cbdt.zip`
- **Domain (defanged):** `material.exe`
- **Domain (defanged):** `statement.zip`
- **Domain (defanged):** `billreceipt.exe`
- **Domain (defanged):** `statement.exe`
- **Domain (defanged):** `account.zip`
- **Domain (defanged):** `node.exe`
- **Domain (defanged):** `run.deobfuscated.obf.js`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `207.56.138.28`, `154.82.81.205`, `45.118.133.203`, `108.187.37.85`, `108.187.42.63`, `108.187.41.221`, `154.82.81.192`, `139.180.128.251` _(+71 more)_
