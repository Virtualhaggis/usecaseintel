...
### Mini Shai-Hulud: Python subprocess spawns `_runtime/start.py` from lightning site-packages

`UC_449_5` · phase: **install** · confidence: **High** · AI-generated for this article
...
### Mini Shai-Hulud PyPI payload known SHA256 (start.py / router_runtime.js)

`UC_449_6` · phase: **install** · confidence: **High** · AI-generated for this article
...
### Mini Shai-Hulud: Bun runtime executing `router_runtime.js` (2nd-stage stealer)

`UC_449_7` · phase: **actions** · confidence: **High** · AI-generated for this article
...
`UC_449_4` · phase: **exploit** · confidence: **High**
