# [CRIT] ARToken: Inside an EvilTokens affiliate panel targeting Microsoft 365

**Source:** Cisco Talos
**Published:** 2026-07-01
**Article:** https://blog.talosintelligence.com/artoken-inside-an-eviltokens-affiliate-panel-targeting-microsoft-365/
...
The ARToken panel exposes 80+ API endpoints for device code phishing, Primary Refresh Token (PRT) persistence, …

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `pamconj.com`
...
`UC_185_10` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
...
`UC_185_12` · phase: **exploit** · confidence: **High** · AI-generated for this article
...
`UC_185_13` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_185_14` · phase: **delivery** · confidence: **Medium** · AI-generated for this article
...
`UC_185_15` · phase: **c2** · confidence: **High** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `pamconj.com`, `dashboard-bl.pamconj.com`, `spx.pamconj.com`, `clear90489058903-document.workers.dev`
