# [MED] Fastify Node.js framework improves JSON security thanks to a security report

**Source:** Snyk
**Published:** 2020-03-10
**Article:** https://snyk.io/blog/fastify-nodejs-improves-json-security/
...
`UC_3419_0` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Fastify Node.js framework improves JSON security thanks to a security report ```
