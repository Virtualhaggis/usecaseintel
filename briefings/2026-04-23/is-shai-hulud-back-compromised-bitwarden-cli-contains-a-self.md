# [HIGH] Is Shai-Hulud Back? Compromised Bitwarden CLI Contains a Self-Propagating npm Worm

**Source:** Aikido
**Published:** 2026-04-23
**Article:** https://www.aikido.dev/blog/shai-hulud-npm-bitwarden-cli-compromise

## Threat Profile

Blog Vulnerabilities & Threats Is Shai-Hulud Back? Compromised Bitwarden CLI Contains a Self-Propagating npm Worm Is Shai-Hulud Back? Compromised Bitwarden CLI Contains a Self-Propagating npm Worm Written by Ilyas Makari Published on: Apr 23, 2026 Version 2026.4.0 of the widely-used @bitwarden/cli npm package (78,000 weekly downloads) has been identified as malicious. The package contains a sophisticated multi-stage credential theft worm that explicitly names itself "Shai-Hulud: The Third Coming…
...
`UC_252_10` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Is Shai-Hulud Back? Compromised Bitwarden CLI Contains a Self-Propagating npm Wo ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("bw_setup.js","bw1.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("bw_setup.js","bw1.js"))
...
| where (FileName in~ ("bw_setup.js", "bw1.js"))
