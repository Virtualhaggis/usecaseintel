...
Tags npm 
Supply chain attack 
Threats intelligence Supply chain attacks 
Content types Research 
Products and services Microsoft Defender 
Topics Actionable threat insights 
Threat intelligence 
On July 14, 2026, Microsoft Threat Intelligence identified a coordinated supply chain compromise of the @asyncapi npm organization, a widely used set of packages for the AsyncAPI specification and code generation. Five package versions across four package names were republished within roughly ninety min…

## Indicators of Compromise (high-fidelity only)

- **IPv4 (defanged):** `85.137.53.71`
- **Domain (defanged):** `rentry.co/elzotebo999`
- **Domain (defanged):** `rentry.co/elzotebo`
- **Domain (defanged):** `ipfs.io/ipfs/QmQobZSp1wRPrpSEQ56qnyq7ecZh5Bg5k1fnjt4SUwwHb9`
- **Domain (defanged):** `ipfs.io/ipfs/Qmet4fhsAaWMBUxNDfREHwgiyDeSWy4YSYs9wiKUW5jGyf`
...
`UC_136_13` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
`UC_136_14` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_136_17` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Unpacking the AsyncAPI npm supply chain compromise and import-time payload deliv ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("node.js","sync.js","index.js") OR Processes.process_path="*%LOCALAPPDATA%\NodeJS\sync.js*")
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_path="*%LOCALAPPDATA%\NodeJS\sync.js*" OR Filesystem.file_path="*/Library/Application*" OR Filesystem.file_name IN ("node.js","sync.js","index.js"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("node.js", "sync.js", "index.js") or FolderPath has_any ("%LOCALAPPDATA%\NodeJS\sync.js"))
...
| where Timestamp > ago(30d)
| where ActionType in ("FileCreated","FileModified")
| where (FolderPath has_any ("%LOCALAPPDATA%\NodeJS\sync.js", "/Library/Application") or FileName in~ ("node.js", "sync.js", "index.js"))
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `85.137.53.71`, `rentry.co/elzotebo999`, `rentry.co/elzotebo`, `ipfs.io/ipfs/QmQobZSp1wRPrpSEQ56qnyq7ecZh5Bg5k1fnjt4SUwwHb9`, `ipfs.io/ipfs/Qmet4fhsAaWMBUxNDfREHwgiyDeSWy4YSYs9wiKUW5jGyf`
