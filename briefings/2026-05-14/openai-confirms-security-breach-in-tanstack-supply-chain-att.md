# [CRIT] OpenAI confirms security breach in TanStack supply chain attack

**Source:** BleepingComputer, Cyber Security News
**Published:** 2026-05-14
**Article:** https://www.bleepingcomputer.com/news/security/openai-confirms-security-breach-in-tanstack-supply-chain-attack/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — OpenAI confirms security breach in TanStack supply chain attack ```
