# [HIGH] SleeperGem Uses Three Malicious RubyGems Packages to Target Developer Machines

**Source:** The Hacker News
**Published:** 2026-07-20
**Article:** https://thehackernews.com/2026/07/sleepergem-uses-three-malicious.html

## Threat Profile

SleeperGem Uses Three Malicious RubyGems Packages to Target Developer Machines 
 Ravie Lakshmanan  Jul 20, 2026 Malware / Application Security 
...
`UC_84_16` · phase: **exploit** · confidence: **High** · AI-generated for this article
...
`UC_84_17` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — SleeperGem Uses Three Malicious RubyGems Packages to Target Developer Machines ```
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_path="*/usr/local/sbin/ping6*" OR Filesystem.file_name IN ("deploy.sh"))
...
| where (FolderPath has_any ("/usr/local/sbin/ping6") or FileName in~ ("deploy.sh"))
