...
- **Domain (defanged):** `github.com/ColossusQuailPray/oiegjqde`
...
`UC_448_10` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `github.com/ColossusQuailPray/oiegjqde`
