# [CRIT] Targeted npm dependency confusion attack caught red-handed

**Source:** Snyk
**Published:** 2022-04-30
**Article:** https://snyk.io/blog/npm-dependency-confusion-attack-gxm-reference/
...
April 30, 2022
0 mins read Attack update timeline May 10, 2022: CodeWhite, a Red Team security company, approached us on Twitter and took ownership over the malicious packages, explaining it was a part of an attack simulation effort for their clients — kudos to them on the elaborate attack!
...
`UC_2285_7` · phase: **c2** · confidence: **High** · AI-generated for this article
...
`UC_2285_8` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_2285_9` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
`UC_2285_10` · phase: **c2** · confidence: **Medium** · AI-generated for this article
...
`UC_2285_6` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Targeted npm dependency confusion attack caught red-handed ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("enc.js","index.js","confsettingsaaa.js","mac.enc.js","mac.dec.js","obfusc.dec.js"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_path="*/etc/hosts*" OR Filesystem.file_path="*/etc/resolv.conf*" OR Filesystem.file_name IN ("enc.js","index.js","confsettingsaaa.js","mac.enc.js","mac.dec.js","obfusc.dec.js"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("enc.js", "index.js", "confsettingsaaa.js", "mac.enc.js", "mac.dec.js", "obfusc.dec.js"))
...
| where (FolderPath has_any ("/etc/hosts", "/etc/resolv.conf") or FileName in~ ("enc.js", "index.js", "confsettingsaaa.js", "mac.enc.js", "mac.dec.js", "obfusc.dec.js"))
