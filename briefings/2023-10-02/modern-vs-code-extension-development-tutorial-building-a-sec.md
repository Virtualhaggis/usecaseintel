# [HIGH] Modern VS Code extension development tutorial: Building a secure extension

**Source:** Snyk
**Published:** 2023-10-02
**Article:** https://snyk.io/blog/modern-vs-code-extension-development-tutorial/
...
`UC_1537_1` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Modern VS Code extension development tutorial: Building a secure extension ```
