...
**Article:** https://thehackernews.com/2026/06/europol-disrupts-audia6-crypto.html

## Threat Profile

Europol Disrupts AudiA6 Crypto Laundering Service Used by Ransomware Gangs 
 Ravie Lakshmanan  Jun 12, 2026 Cybercrime / Dark Web 
...
Europol, in a statement issued Thursday, said the dismantling of AudiA6 cut off a "key financial pipeline used to wash hundreds of millions in illicit profits." The service is estimated to have been used to launder more than €336 mi…

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `designli.pictures`
- **Domain (defanged):** `pheontx.eu`
- **Domain (defanged):** `smplfy.in`
- **Domain (defanged):** `sumato-soft.org`
- **Domain (defanged):** `technobrains.dev`
- **Domain (defanged):** `lett.email`
- **Domain (defanged):** `trayo.app`
- **Domain (defanged):** `deliverly.top`
- **Domain (defanged):** `inboxly.top`
- **Domain (defanged):** `postfast.eu`
- **Domain (defanged):** `postino.click`
- **Domain (defanged):** `inboxally.agency`
- **Domain (defanged):** `mailora.eu`
- **Domain (defanged):** `postify.email`
- **Domain (defanged):** `quix.express`
- **Domain (defanged):** `flowcomm.click`
- **Domain (defanged):** `qube.black`
- **Domain (defanged):** `deliverlett.com`
- **Domain (defanged):** `lettermail.eu`
...
`UC_140_12` · phase: **delivery** · confidence: **High** · AI-generated for this article
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `designli.pictures`, `pheontx.eu`, `smplfy.in`, `sumato-soft.org`, `technobrains.dev`, `lett.email`, `trayo.app`, `deliverly.top` _(+11 more)_
