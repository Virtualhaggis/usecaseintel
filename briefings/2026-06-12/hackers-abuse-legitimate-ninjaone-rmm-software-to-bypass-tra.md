...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `r64.org`, `hairdb.com`, `lazybearpottery.net`, `rectalmania.com`, `sefaz.services`, `reclameaqui.services`
