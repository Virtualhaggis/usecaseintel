...
**Article:** https://thehackernews.com/2026/06/agentjacking-attack-tricks-ai-coding.html

## Threat Profile

Agentjacking Attack Tricks AI Coding Agents Into Running Malicious Code 
 Ravie Lakshmanan  Jun 12, 2026 Artificial Intelligence / Vulnerability 
...
Called Agentjacking by Tenet Security, the attack can be triggered by means of a fake error report crafted using Sentry, an open-source error-tracking and performa…

## Indicators of Compromise (high-fidelity only)

- **Domain (defanged):** `advisory-tracker.com`
...
- **Network connections to article IPs / domains** ([template](../_TEMPLATES.md#network-ioc)) — phase: **c2**, confidence: **High**
  - IP / domain IOC(s): `advisory-tracker.com`
