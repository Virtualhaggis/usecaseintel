# [HIGH] Hardening Amazon EKS security with RBAC, secure IMDS, and audit logging

**Source:** Snyk
**Published:** 2021-07-07
**Article:** https://snyk.io/blog/hardening-aws-eks-security-rbac-secure-imds-audit-logging/
...
`UC_3132_2` · phase: **install** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Hardening Amazon EKS security with RBAC, secure IMDS, and audit logging ```
