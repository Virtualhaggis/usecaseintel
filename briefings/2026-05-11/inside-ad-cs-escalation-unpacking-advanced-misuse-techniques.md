...
**Article:** https://unit42.paloaltonetworks.com/active-directory-certificate-services-exploitation/
...
`UC_314_14` · phase: **exploit** · confidence: **High** · AI-generated for this article
...
`UC_314_15` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_314_16` · phase: **install** · confidence: **High** · AI-generated for this article
...
`UC_314_17` · phase: **actions** · confidence: **Medium** · AI-generated for this article
...
`UC_314_18` · phase: **exploit** · confidence: **Medium** · AI-generated for this article
...
`UC_314_13` · phase: **exploit** · confidence: **High**

**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Inside AD CS Escalation: Unpacking Advanced Misuse Techniques and Tools ```
| tstats `summariesonly` count earliest(_time) AS firstTime latest(_time) AS lastTime
    from datamodel=Endpoint.Processes
    where (Processes.process_name IN ("update6.exe","adexplorer.exe"))
...
| tstats `summariesonly` count
    ...
    where Filesystem.action IN ("created","modified")
      AND (Filesystem.file_name IN ("update6.exe","adexplorer.exe"))
...
DeviceProcessEvents
| where Timestamp > ago(30d)
| where (FileName in~ ("update6.exe", "adexplorer.exe"))
