# [MED] Securing the Agent Skill Ecosystem: How Snyk and Vercel Are Locking Down the New Software Supply Chain

**Source:** Snyk
**Published:** 2026-02-17
**Article:** https://snyk.io/blog/snyk-vercel-securing-agent-skill-ecosystem/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — Securing the Agent Skill Ecosystem: How Snyk and Vercel Are Locking Down the New ```
