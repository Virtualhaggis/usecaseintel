# [HIGH] The security concerns of a JavaScript sandbox with the Node.js VM module

**Source:** Snyk
**Published:** 2023-02-22
**Article:** https://snyk.io/blog/security-concerns-javascript-sandbox-node-js-vm-module/
...
**Splunk SPL (CIM):**
```spl
``` Article-specific bespoke detection — The security concerns of a JavaScript sandbox with the Node.js VM module ```
